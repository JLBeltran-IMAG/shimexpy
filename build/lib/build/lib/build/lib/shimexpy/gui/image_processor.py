"""
Controlador para la gestión de funciones de procesamiento en ShimExPy.

Este módulo proporciona un controlador que maneja el procesamiento de imágenes
utilizando las funciones de ShimExPy para el análisis de armonías espaciales.
"""
...
from shimexpy.io.file_io import load_image, save_image
