...
def process_sample(sample_path, reference, ref_block_grid, output_dir, contrast_type="absorption"):
...
def batch_process_samples(reference_path, sample_dir, output_dir, contrast_type="absorption", n_workers=None):
